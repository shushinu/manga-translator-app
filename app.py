...
""",
        ...
        "translate_system": (
            ...
            "6) 优先产生自然、地道的台湾华语口吻；避免直译腔与不自然词汇。标点符号用台湾常见用法。\n"
        ...
        "combined_header": (
            "请根据下列参考资料，将提供的日文漫画对白翻译为自然、符合角色语气的台湾繁体中文。"
...
if st.session_state["lang"] == "zh-Hans":
    ...
    <style>
        html, body, [class*="css"]  { font-family: 'Noto Sans SC', 'Microsoft YaHei', 'PingFang SC', sans-serif; }
    ...
    <style>
        html, body, [class*="css"]  { font-family: 'Noto Sans TC', 'Microsoft JhengHei', 'PingFang TC', sans-serif; }
        div.block-container{padding-top: 1.2rem;}
    </style>
    """, unsafe_allow_html=True)
